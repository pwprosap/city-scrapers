...
class AlleCountyCouncilSpider(Spider):
    name = 'alle_county_council'
    agency_name = 'Allegheny County Council'
    timezone = 'America/Chicago'
    allowed_domains = ['www.alleghenycounty.us']
    start_urls = ['https://alleghenycounty.legistar.com/Calendar.aspx']
